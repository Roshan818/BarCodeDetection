...
def localized(image):
    ...
    cv2.imwrite(r"BarCodeDetection/sample/allbarcode/IMG_20220303_173611.jpg", result_res)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    result_res2=cv2.imread(r"BarCodeDetection/sample/allbarcode/IMG_20220303_173611.jpg")
    BarcodeReader(result_res2)
#methood to decode bar code
def BarcodeReader():
    # read the image in numpy array using cv2
    img =cv2.imread(r"BarCodeDetection/sample/allbarcode/IMG_20220303_173611.jpg", cropped)
